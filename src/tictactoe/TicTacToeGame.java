...
/**
 * The model class for tic-tac-toe game that included logic of this game and
 * updates board view also.
 */
public class TicTacToeGame {
	...
	public void startNewGame() {
		...
		// Remove Pieces from the board (view), but not the squares themselves. Use a
		// Predicate to test for Piece.
